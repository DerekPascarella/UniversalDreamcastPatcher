...
## Latest Version
The latest version of Universal Dreamcast Patcher is [1.8](https://github.com/DerekPascarella/UniversalDreamcastPatcher/releases/download/1.8/Universal.Dreamcast.Patcher.v1.8.zip).
